...
public class MainPanel extends JPanel {
	...
	public MainPanel(int beanCount, boolean isLuck) {
		...
		_logic.reset(_beans, _logic, true);
	...
	public void lowerHalf() {
		_logic.lowerHalf(_logic);
		repaint();
	}

	public void upperHalf() {
		_logic.upperHalf(_logic);
		repaint();
	}
	...
	public void drawStats(Graphics g) {
		...
		String average = "Average = " + new DecimalFormat("#.##").format(_logic.getAverageSlotBeanCount(_logic));
